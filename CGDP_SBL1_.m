...
%%
tstart1 = tic;
[Source_power_re,Azimuth,source_id_,j1]=CGDP_SBL1(Y,Azimuth_grid,grid_interval,Aa,K);   % K is known
...
legend('CGDP-SBL1')
function [source_power,Azimuth,source_id,iter]=CGDP_SBL1(Y,Azimuth_grid,grid_interval,Aa,K_)
%% input:
%% Y: Array output data
